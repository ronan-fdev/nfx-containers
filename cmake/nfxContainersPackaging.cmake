#==============================================================================
# nfx-containers - Library packaging configuration (CPack)
#==============================================================================
...
if(NOT NFX_CONTAINERS_PACKAGE_SOURCE
		AND NOT NFX_CONTAINERS_PACKAGE_ARCHIVE
		AND NOT NFX_CONTAINERS_PACKAGE_DEB
		AND NOT NFX_CONTAINERS_PACKAGE_RPM
		AND NOT NFX_CONTAINERS_PACKAGE_WIX)
...
set(CPACK_PACKAGE_DESCRIPTION_SUMMARY   "Modern C++20 header-only library providing high-performance hash containers with Robin Hood and perfect hashing")
...
set(CPACK_RESOURCE_FILE_LICENSE         ${NFX_CONTAINERS_LICENSE_FILE})
...
if(NFX_CONTAINERS_PACKAGE_SOURCE)
...
set(CPACK_PACKAGE_INSTALL_REGISTRY_KEY  "nfx-containers")
...
if(NOT DEFINED CPACK_GENERATOR)
	...
	# --- Archive packages ---
	if(NFX_CONTAINERS_PACKAGE_ARCHIVE)
	...
	# --- DEB packages ---
	if(NFX_CONTAINERS_PACKAGE_DEB AND UNIX AND NOT APPLE)
	...
	# --- RPM packages ---
	if(NFX_CONTAINERS_PACKAGE_RPM AND UNIX AND NOT APPLE)
	...
	# --- WiX packages ---
	if(NFX_CONTAINERS_PACKAGE_WIX AND WIN32)
...
if("RPM" IN_LIST CPACK_GENERATOR AND UNIX AND NOT APPLE)
	...
	set(CPACK_RPM_PACKAGE_LICENSE       ${NFX_CONTAINERS_LICENSE})

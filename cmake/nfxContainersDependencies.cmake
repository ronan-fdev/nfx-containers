...
if(NOT nfx-hashing)
	message(STATUS "nfx-hashing not found on system, using FetchContent")
	...
	message(STATUS "Using system-installed nfx-hashing version ${nfx-hashing_VERSION} at ${nfx-hashing_DIR}")
endif()

# --- Google test ---
if(NFX_CONTAINERS_BUILD_TESTS)
...
# --- Google benchmark ---
if(NFX_CONTAINERS_BUILD_BENCHMARKS)
